...
str = "+82-5094-1145";
regexp = /\d{4}/g;
console.log(str.match(regexp)); // [5094, 1145]

console.log(str.match(/\d{2,3}/g)); // [82, 509, 114]

console.log(str.match(/\d{2,}/g)); // [ '82', '5094', '1145' ]

str = "Should I write color or colour?";
console.log(str.match(/colou?r/g)); // color, colour

str = "100 10 1";
console.log(str.match(/\d0*/g)); // 100 10 1

console.log(str.match(/\d0+/g)); // 100 10

console.log(str.match(/\d0?/g)); // 10 0 10 1

str = `<body>
    <h1>This is bird</h1>
    <p>bird's name is raven</p>
    <a href="link" class="doc">
</body>`;

console.log(str.match(/<[a-z0-9]+>/gim));
console.log(str.match(/<\/?[a-z0-9]*>/gim));

regexp = /<a href=".*" class="doc">/gm;

console.log(str.match(regexp));

console.log("gogoGogogo let go".match(/(go)+/gi));
...
regexp = /html|php|css|java(script)?/gi;
str = "First HTML appeared, then CSS, then JavaScript then Java";
console.log(str.match(regexp));
...
str = "안녕하세요 반갑습니다 제 이름은 곽세진 입니다.";
console.log(str.search(/이름/g)); // firstIndex

str = "I love javascript and react";
console.log(/love/gi.test(str)); // 없다면 -1
// matchAll, replace, exec
